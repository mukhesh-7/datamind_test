    ...
    <header className="bg-gray-500 border border-cyan-200 backdrop-brightness-150 py-2 px-4 mt-7 mx-6 rounded-full shadow-glow shadow-blue-600 backdrop-blur-lg bg-opacity-30">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-5 mt-2 my-2">
          <Button size="sm" className="text-white bg-none px-2 py-1 rounded-full shadow-md hover:bg-primary-600">
            Home
          </Button>

          <Button size="sm" className="text-white bg-none px-1 py-1 rounded-full shadow-md hover:bg-primary-600">
            Dashboard
          </Button>

          <Button size="sm" onClick={openAuthModal}  className=" text-white px-3 py-1 my-2-1 rounded-full bg-none shadow-md hover:bg-primary-600 transition-colors duration-300 text-sm ">
            Register
          </Button>
        
          <Button size="sm" className="bg-none px-2 py-2 rounded-full hover:bg-primary-600" onClick={handleUpgradeClick}>
            Upgrade to Pro
          </Button>
        </div>
      </div>
